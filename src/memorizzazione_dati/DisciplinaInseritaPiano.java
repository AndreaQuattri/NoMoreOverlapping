...
public class DisciplinaInseritaPiano {
	...
	public int getRiga (String d){
		...
		if (d.substring(0, 2).compareTo("13")<0)
			return getRigaMinore(d);
		else
			return getRigaMaggiore(d);
	...
	private int getRigaMaggiore(String d) {
	...
	private int getRigaMinore(String d) {
	...
	public String getTime(int riga) {
		...
		if (riga < 10)
			return getTimeMinore(riga);
		else
			return getTimeMaggiore(riga);
	...
	private String getTimeMaggiore(int riga) {
		switch (riga){
		case 11:
			return "14:00:00";
		case 12:
	...
	private String getTimeMinore(int riga) {
		switch (riga){
		case 0:
			return "08:30:00";
		case 1:
