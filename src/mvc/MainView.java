...
public class MainView extends JFrame implements Observer {
	...
	private void initViewLikeModel()
	{
		...
		buttonInsertNewTable.setEnabled(model.isEnableInserisciButton());
	...
	public void enableButtonInserisci(){
		buttonInsertNewTable.setEnabled(model.isEnableInserisciButton());
	}
	...
	public void update(Observable o, Object arg)
	{
		...
		case MyNotify.ENABLE_BUTTON_AGGIORNA:
			...
			break;
		case MyNotify.ENABLE_BUTTON_INSERISCI:
			enableButtonInserisci();
			break;
